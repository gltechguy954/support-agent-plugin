...
namespace WP_Ultimo_Support_Agents\Models;
 ...
 * @since 2.0.0
 */
class Support_Agent extends \WP_Ultimo\Models\Customer {
	...
	public function validation_rules() {
		...
		return array(
			'user_id'            => "required|unique:WP_Ultimo_Support_Agents\Models\Support_Agent,user_id,{$id}|integer",
	...
	/**
	 * Set the Support Agent type.
	 *
	 * @since 1.0.3
	 * @param string $type The support-agent type. Can be 'support-agent'.
	 * @options support-agent
	 * @return void
	 */
