<?php
/**
 * Class used for querying support_agents.
 *
 * @package WP_Ultimo
...
namespace WP_Ultimo_Support_Agents\Database\Customers;
 ...
 * @since 2.0.0
 */
class Support_Agent_Query extends \WP_Ultimo\Database\Engine\Query {
	 ...
	 * @var string
	 */
	protected $item_name_plural = 'support_agents';
	 ...
	 * @var mixed
	 */
	protected $item_shape = '\\WP_Ultimo_Support_Agents\\Models\\Support_Agent';
	 ...
	 * @var string
	 */
	protected $cache_group = 'support_agents';
